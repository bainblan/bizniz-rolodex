...
export function AuthModal({
    onClose, // prop passed from parent responsible for closing modal when user click close
    onAuthed, // prop passed from parent responsible for closing modal on successful auth
  }: {
    onClose: () => void; // TypeScript definition: no inputs, no return
    onAuthed: () => void; // TypeScriptDefinition: no inputs, no return
    }) {
